...
import com.example.iitmap.services.map.PointService
...
class PointController(private val service: PointService) : PointApi {
    override fun getPointsOnFloor(buildingId: Long, floorNumber: Int): ResponseEntity<List<Point>> = ResponseEntity.ok(
